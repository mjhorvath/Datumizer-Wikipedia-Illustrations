// Caption: Munsell 1943 color solid cylinder (swatches in sRGB gamut only)
...
#declare Muns_hue_adjust	= Muns_slice_angle * (4 + 5);
#declare Muns_color_clamp	= 1;

#declare Muns_time_spin		= SetClock2(0/3, 1/3);
#declare Muns_time_wipe1	= SetClock1(1/3, 2/3);
#declare Muns_time_wipe2	= floor(19 * Muns_time_wipe1 + 1/2)/19 + 1/20/2;		// looks like crap, dubious
...
{
	plane {+x, 0}
	#if (Muns_time_wipe2 < 1)
		plane {-x, 0 rotate +y * Muns_time_wipe2 * 180}
	#end
...
union
{
	union
	{
		...
		difference
		{
			...
			{
				4, <0, 0,>, <1, 0,>, <1, 1,>, <0, 1,>
				pigment {image_map {png "munsell_horizontal_cross_section_26_trans.png"}}
				translate	-x/2
				translate	-y/2
				scale		+x * 1500/1350 * 27
				scale		+y * 1500/1350 * 27
				rotate		+x * 90
	...
	difference
	{
		...
		{
			4, <0, 0,>, <1, 0,>, <1, 1,>, <0, 1,>
			pigment {image_map {png "munsell_vertical_cross_section_26_trans.png"}}
			translate	-x/2
			translate	-y/2
			scale		+x * 1500/1350 * 27
			scale		+y * 700/550 * 11

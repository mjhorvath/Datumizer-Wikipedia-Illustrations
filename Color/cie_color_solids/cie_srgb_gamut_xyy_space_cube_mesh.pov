// Title: CIE XYY Color Solid Cube Mesh
...
#declare cie_cspace_other	= 0;		// which color space is this?
#declare cie_mesh_file_other	= "cie_other_xyy_cub_mesh.inc";
...
union
{
	...
	{
		4, <0, 0,>, <1, 0,>, <1, 1,>, <0, 1,>
		pigment {image_map {png "cie_axis_x1_y1_cub_sans.png"}}	// need to replace this
		scale		440/320

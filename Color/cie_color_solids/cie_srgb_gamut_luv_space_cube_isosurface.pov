...
#declare cie_fOutR = function(L,U,V) {cie_funcLUV2RGBa1(L,U,V)}
#declare cie_fOutG = function(L,U,V) {cie_funcLUV2RGBa2(L,U,V)}
#declare cie_fOutB = function(L,U,V) {cie_funcLUV2RGBa3(L,U,V)}

// Title: CIE LCHuv Color Solid Cylinder Mesh
...
#declare cie_cspace0_visible	= 6;
#declare cie_mesh_file_visible	= "cie_visible_lchuv_cyl_d65_mesh.inc";
...
union
{
	...
	union
	{
//		cie_plot_gridlines_visible(6)
//		cie_plot_polkadots_visible(6)

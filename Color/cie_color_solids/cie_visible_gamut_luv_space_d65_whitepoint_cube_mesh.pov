// Title: CIE LUV Visible Gamut Cube Mesh
...
#declare cie_cspace0_visible	= 5;
#declare cie_mesh_file_visible	= "cie_visible_luv_cub_d65_mesh.inc";
...
union
{
	...
	{
		4, <0, 0,>, <1, 0,>, <1, 1,>, <0, 1,>
		pigment {image_map {png "cie_axis_u200_v200_cub_sans.png"}}
		scale		440/320
	...
	union
	{
//		cie_plot_gridlines_visible(5)
//		cie_plot_polkadots_visible(5)

...
#declare cie_fOutR = function(L,C,H) {cie_funcLCHuv2RGBa1(L,C,H)}
#declare cie_fOutG = function(L,C,H) {cie_funcLCHuv2RGBa2(L,C,H)}
#declare cie_fOutB = function(L,C,H) {cie_funcLCHuv2RGBa3(L,C,H)}

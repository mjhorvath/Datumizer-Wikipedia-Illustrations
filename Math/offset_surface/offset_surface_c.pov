...
background {color srgb <191,211,255>/255}
...
#declare MySolidMat2 = material
{
	texture
	{
		pigment {color srgb <191,0,0>/255}
		normal {agate 0.25 scale 0.15}
		finish {phong 1} 
		scale 1/4
	}

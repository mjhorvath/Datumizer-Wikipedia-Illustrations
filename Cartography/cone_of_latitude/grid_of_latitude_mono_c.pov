// The Earth texture is simply scaled vertically from perfectly spherical, as is the graticule. This is the most primitive option, but maybe sufficient for Wikipedia.

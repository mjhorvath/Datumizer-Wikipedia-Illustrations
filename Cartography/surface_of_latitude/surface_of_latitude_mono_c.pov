// The Earth texture is simply scaled vertically from perfectly spherical, as is the graticule. This is the most primitive option, but maybe sufficient for Wikipedia. The intersection is with a truncated cone.
// +wt11 +q11 +am2 +r4 -j
// +KFI0 +KFF48
...
{
	0,0.25,y*sphere_scale,0.538675134594814		// values copied directly from geogebra
}
